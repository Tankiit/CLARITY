#!/bin/bash
# Script to visualize a trained model

# Check if model path is provided
if [ -z "$1" ]; then
    echo "Usage: $0 <model_directory> [dataset]"
    echo "Example: $0 yelp_models/20250520-084354_distilbert-base-uncased"
    echo "Example with dataset override: $0 yelp_models/20250520-084354_distilbert-base-uncased sst2"
...
python visualize_model.py \
    ...
    --dataset "$DATASET" \
    --output_dir "${MODEL_DIR}/visualizations_detailed"
